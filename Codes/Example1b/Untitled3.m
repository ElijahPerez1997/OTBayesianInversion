...
theta3=zeros(1,M);theta3_0=25;theta3(1)=theta3_0;%Multiplicitive hyperparameter
%Memory prellocation
...
while i<M
    ...
    if theta3_s<0
           theta3_s=30-mod(1,theta3_s);
    elseif theta3_s>30
           theta3_s=theta3_s-30;
    end
  ...
  for k=1:nr
    ...
    if 2>theta2_s || theta2_s>8
     ...
     if 0>theta3(i) || theta3(i)>30 || 0>theta3_s || theta3_s>30
        alpha=-1E10;
    end
    u=rand(1);%U hat
